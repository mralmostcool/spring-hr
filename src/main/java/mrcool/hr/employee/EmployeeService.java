...
import mrcool.hr.designation.DesignationRepository;
import mrcool.hr.employee.dto.EmployeeMapper;
import mrcool.hr.employee.dto.EmployeeRequestDTO;
import mrcool.hr.employee.dto.EmployeeResponseDTO;
...
public class EmployeeService {
    ...
    public EmployeeResponseDTO createEmployee(EmployeeRequestDTO request) {
        Designation designation = designationRepository.findById(request.designationId())
                .orElseThrow(() -> new ResourceNotFoundException("Designation with ID " + request.designationId() + " not found"));
